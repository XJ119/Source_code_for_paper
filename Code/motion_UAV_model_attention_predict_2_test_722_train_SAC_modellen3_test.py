...
writer = SummaryWriter("flocking_run\experment_interprupt_attention_UAV_model_2_predict_SAC_train_8_Entropy_1_5_test")#_6 0.012
...
def aciton_select_function(GCN_actor_policy,state,sub_adjacency_matrix,state_obs,sub_adjacency_matrix_obs,agent_i,x_1,v_1,adj,nbr,dist_2,x_r,v_r):#概率决定行为
    ...
    if sample > -10 :
        ...
        with torch.no_grad():
            ...
            return_action = return_action_mean#dist.sample()
